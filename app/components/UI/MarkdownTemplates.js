const TEMPLATES = {
  schedule: {
    ...
    text: `| Day/Hours | 10 AM | 12 AM | 2 PM | 4 PM  | 6 PM |
    |:--- |:--- |:--- |:--- |:--- |:--- |
    | **Monday** |  |  |  |  |  |
    | **Tuesday** |  |  |  |  |  |
    | **Wednesday** |  |  |  |  |  |
  ...
  readme: {
    title: 'README',
    text: `> MDyna is a markdown notes application that syncs with Github gists, and much more

    ### 🏠 Homepage

    Linux and Windows Build:
    [https://circleci.com/gh/mdyna/mdyna-app/tree/master](https://circleci.com/gh/mdyna/mdyna-app/tree/master)
    MacOS Build
    ![GitHub Actions status](https://github.com/mdyna/mdyna-app/workflows/macOS%20CD/badge.svg)
    Landing Page:
    [https://app.netlify.com/sites/mdyna/deploys](https://app.netlify.com/sites/mdyna/deploys)
    [https://github.com/mdyna/mdyna-app/releases](https://github.com/mdyna/mdyna-app/releases)
